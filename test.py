...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='best0104.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/fires.yaml', help='*.data path')
